export default function Contact() {
  return (
     <section id="contact" className="min-h-[calc(100vh-1rem)] bg-retro-offwhite">
      <div className="container flex flex-col py-24 mx-auto lg:max-w-6xl px-8 md:px-12 py-24 md:pt-30">
        ...
        <div>
          <form className="w-full space-y-4 md:space-y-8 md:bg-white md:p-8 md:rounded-md md:shadow-sm">
            ...
            <button className="mt-8 w-full bg-retro-blue text-white rounded py-2 px-4 md:py-4 md:px-8" type="submit">Submit</button>
          </form>
        </div>
      </div>
    </section>
