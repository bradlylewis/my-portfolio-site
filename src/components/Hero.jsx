export default function Hero() {
  return (
    <section id="hero" className="min-h-[calc(100vh-4rem)] flex items-center flex-column">
      <div className="container mx-auto lg:max-w-6xl px-4 md:px-12">
        ...
        <div className="flex flex-col md:flex-row gap-4 text-center mt-24">
          <a href="#projects" className="bg-teal-500 text-white py-5 md:py-4 md:px-8 rounded font-bold hover:bg-teal-600 mr-2 transition">View My Projects</a>
